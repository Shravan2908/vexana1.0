...
def ban(update: Update, context: CallbackContext) -> str:
    ...
    if is_user_ban_protected(chat, user_id, member) and user not in DEV_USERS:
        if user_id == OWNER_ID:
            ...
            message.reply_text(
                "Fighting this Dragons here will put user lives at risk."
            )
        elif user_id in DEMONS:
            message.reply_text(
                "Bring an order from my Master @itzz_axel to do this."
            )
        ...
        bot.sendMessage(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Give_Chance", callback_data=f"unbanb_unban={user_id}"
                        ),
                        InlineKeyboardButton(text="Ignor", callback_data="unbanb_del"),
                    ]
                ]
            ),
...
def temp_ban(update: Update, context: CallbackContext) -> str:
    ...
    if not user_id:
        message.reply_text("Piro! at least refer some user to ban...")
        return log_message
    ...
    try:
        ...
        return log_message
    if user_id == bot.id:
        message.reply_text("I'm not gonna BAN myself, you noob?")
        return log_message
        ...
        bot.sendMessage(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Give Chance", callback_data=f"unbanb_unban={user_id}"
                        ),
                        InlineKeyboardButton(text="Ignor", callback_data="unbanb_del"),
                    ]
                ]
...
def punchme(update: Update, context: CallbackContext):
    ...
    if res:
        update.effective_message.reply_text("*Banned a Noob Successfully For HEre *")
    else:
