from vexana import  DRAGONS, OWNER_ID
from pyrogram import filters
from vexana import pbot as pbot
...
mongoPY = MongoClient(MONGO_DB_URI)


gban = {}
rgban = {}
gban_users = mongoPY.gbanusers
...
async def gban(message):
	...
	if message.sender_id not in  DRAGONS:
		return
