...
def stats(update, context):
    ...
    status = "*╒═══📊 Current stats of Vexana*\n\n"
        ...
        update.effective_message.reply_text(
            (
                (
                    ...
                    + f"\n\n⊙ [Support](https://t.me/vexana_support) | ⊙ [Updates](https://t.me/vexana_updates)\n\n"
                )
                + "╘══「 POwered BY  [VexanaFanClub](https://t.me/joinchat/bUur6UDhJMMzMmM1) 」\n"
            ),
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
        )
